...
-- Purpose: Identify best-selling products based on total revenue
...
-- Purpose: Compare revenue and profitability by category
...
-- Purpose: Identify sales behavior by weekday
